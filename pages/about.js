...
export default function About() {
  return (
    <div className="text-center py-10 max-w-4xl mx-auto px-4">
      <h2 className="text-3xl font-bold text-yellow-400 mb-4">About CardVerse</h2>
      <p className="text-white-700 text-lg leading-relaxed mb-4">
        <strong>CardVerse</strong> is your ultimate Magic: The Gathering companion — built by players, for players. Whether you're a casual collector or a competitive deckbuilder, CardVerse brings your card library to life with powerful, intuitive tools.
      </p>
      <p className="text-white-700 text-lg leading-relaxed mb-4">
      ...
      <p className="text-white-700 text-lg leading-relaxed mb-6">
        CardVerse is more than a database — it’s a personal hub for organizing, discovering, and enjoying the Magic multiverse. And we're just getting started.
      </p>
      <div className="text-sm text-red-500">
        CardVerse uses data provided by{' '}
        <a
